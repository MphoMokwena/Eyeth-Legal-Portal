                                ...
                                <div class="row">
                                    <div class="col-xs-6 text-left">
                                        <div class="checkbox checkbox-inline checkbox-styled">
                                            <label>
                                                <input input type="checkbox" name="remember" id="remember" required {{ old('remember') ? 'checked' : '' }}> <span>Remember me</span>
                                            </label>
                                        </div>
                                    </div><!--end .col -->
                                    ...
                                    <div class="col-xs-12">
                                        <br>
                                        <button class="btn btn-block btn-primary btn-raised" type="submit">Login</button>
                                        <a class="btn btn-block btn-raised btn-primary" href="{{ route('register') }}">Create Account</a>
                                    </div>
                                </div><!--end .row -->
                            </form>
                        </div><!--end .col -->
