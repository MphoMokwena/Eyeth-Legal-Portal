                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <form method="POST"  class="form floating-label" action="{{ route('password.update') }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <br>
                                        <button class="btn btn-block btn-primary btn-raised" type="submit">Reset Password</button>
